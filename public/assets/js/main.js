// Enable dragging via Sortable.js
...
document.querySelectorAll('.add-task-btn').forEach(btn => {
    btn.addEventListener('click', () => {
        ...
        // If the task inputs are empty and unfocused, delete the task entirely
        ...
        // Focus the title to start typing
        titleInput.focus();
    });
});
